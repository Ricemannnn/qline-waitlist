...
import { 
  ...
  MessageSquare, Clock, Smartphone, ShieldCheck, HelpCircle, Mail, Lock, Menu, X, LayoutDashboard, Sun, Moon
} from 'lucide-react';
...
const LandingPage = ({ isDarkMode, toggleDarkMode }) => {
  ...
  return (
    <div className="min-h-screen bg-[#FFFDF9] dark:bg-gray-950 text-[#1A1A1A] dark:text-gray-100 font-sans scroll-smooth transition-colors duration-300">
      {/* Header */}
      <header className="px-6 py-4 flex items-center justify-between border-b border-gray-100 dark:border-gray-800 sticky top-0 bg-[#FFFDF9]/80 dark:bg-gray-950/80 backdrop-blur-md z-50">
      ...
      {/* Mobile Nav Overlay */}
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-40 bg-white dark:bg-gray-950 md:hidden pt-20 px-6">
          <nav className="flex flex-col gap-6 text-center">
            ...
            <div className="flex justify-center py-4">
              <button 
                onClick={toggleDarkMode}
                className="p-4 rounded-2xl bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400"
              >
      ...
      <section className="py-20 md:py-32 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-flex items-center gap-2 bg-orange-50 dark:bg-orange-950/20 text-[#F36D21] px-4 py-2 rounded-full text-sm font-bold mb-6">
            ...
            <p className="mt-8 text-xl text-gray-600 dark:text-gray-400 leading-relaxed text-center md:text-left">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              ...
              <a href="#how-it-works" className="px-8 py-4 rounded-xl font-bold text-lg border-2 border-gray-200 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-900 transition-all text-center flex items-center justify-center gap-2">
                See How It Works
              </a>
            </div>
          ...
          <div className="relative">
            <div className="absolute -inset-4 bg-orange-100/50 dark:bg-[#F36D21]/10 rounded-[40px] blur-3xl -z-10"></div>
            <div className="shadow-2xl rounded-[32px] p-8 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 relative overflow-hidden">
              ...
              <ul className="space-y-4">
                <li className="flex items-center justify-between p-4 bg-orange-50/50 dark:bg-orange-950/20 rounded-2xl border border-orange-100 dark:border-orange-900/30 transition-all hover:scale-[1.02]">
                  <div>
                    <p className="font-bold text-lg">Sarah M.</p>
                    <p className="text-sm text-gray-500">Party of 4</p>
                  </div>
                  <div className="flex flex-col items-end">
                    <span className="bg-white dark:bg-gray-800 px-4 py-1 rounded-full text-[#F36D21] font-bold shadow-sm">15 min</span>
                    <span className="text-[10px] text-green-500 font-bold mt-1 uppercase">Notified 2m ago</span>
                  </div>
                </li>
                <li className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-gray-100 dark:border-gray-800 opacity-80">
                  <div>
                    <p className="font-bold text-lg text-gray-700 dark:text-gray-300">James R.</p>
                    <p className="text-sm text-gray-500">Party of 2</p>
                  </div>
                  <span className="bg-white dark:bg-gray-800 px-4 py-1 rounded-full text-gray-400 font-bold shadow-sm">5 min</span>
                </li>
              </ul>
              <p className="mt-6 text-sm text-gray-500 dark:text-gray-400 italic text-center font-medium">
      ...
      <section id="how-it-works" className="py-24 bg-gray-50 dark:bg-gray-900/50 px-6">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-black tracking-tight">How Qline Works</h2>
          <p className="mt-4 text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">From walk‑in to seated in three simple steps.</p>
      ...
      <section className="py-24 px-6 overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-white dark:bg-gray-900 p-10 rounded-[40px] border border-gray-100 dark:border-gray-800 shadow-sm relative">
              <div className="absolute -top-4 -left-4 text-6xl text-orange-100 dark:text-orange-950 font-serif">“</div>
              <p className="text-xl text-gray-700 dark:text-gray-300 leading-relaxed mb-8 relative z-10">
              ...
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-orange-100 dark:bg-orange-900/30 rounded-full flex items-center justify-center text-[#F36D21] font-bold">MB</div>
                <div>
                  <p className="font-bold">Marcus Bennett</p>
                  <p className="text-sm text-gray-500 dark:text-gray-400">General Manager, The Golden Fork (Austin, TX)</p>
                </div>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-900 p-10 rounded-[40px] border border-gray-100 dark:border-gray-800 shadow-sm relative">
              ...
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-orange-100 dark:bg-orange-900/30 rounded-full flex items-center justify-center text-[#F36D21] font-bold">SL</div>
                <div>
                  <p className="font-bold">Sophia Lopez</p>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Owner, Blue Wave Seafood (Miami, FL)</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="features" className="py-32 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="mt-4 text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">Designed for busy Clover restaurants.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
            {[
              ...
              <div key={i} className="p-10 bg-[#FFFDF9] dark:bg-gray-900 rounded-3xl border border-gray-100 dark:border-gray-800 hover:shadow-xl hover:shadow-gray-100 dark:hover:shadow-black transition-all text-left">
                <div className="w-14 h-14 bg-white dark:bg-gray-800 rounded-2xl flex items-center justify-center mb-6 shadow-sm border border-gray-50 dark:border-gray-700">{f.icon}</div>
      ...
      {/* PRICING SECTION */}
      <section id="pricing" className="py-32 bg-gray-50 dark:bg-gray-900/50 px-6">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-black tracking-tight">Simple Pricing</h2>
          <p className="mt-4 text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">No contracts. No setup fees. Cancel anytime.</p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-20 max-w-5xl mx-auto text-left">
            <div className="bg-white dark:bg-gray-900 p-12 rounded-[40px] border-4 border-[#F36D21] relative shadow-2xl shadow-orange-100 dark:shadow-black transform md:scale-105 z-10">
              ...
              <div className="flex items-center gap-1 mb-8">
                <span className="text-7xl font-black text-[#1A1A1A] dark:text-white tracking-tighter">$49</span>
            ...
            <div className="bg-white dark:bg-gray-900 p-12 rounded-[40px] border border-gray-100 dark:border-gray-800 shadow-xl flex flex-col justify-center">
              <h3 className="text-3xl font-black mb-2">Free Trial</h3>
              <div className="flex items-center gap-1 mb-8">
                <span className="text-7xl font-black text-gray-400 dark:text-gray-600 tracking-tighter">$0</span>
                <div className="leading-none">
              ...
              <ul className="space-y-4 mb-10">
                <li className="flex items-center gap-3 font-semibold text-gray-500 dark:text-gray-400"><CheckCircle2 className="text-green-500" size={20} /> Full access to all features</li>
                <li className="flex items-center gap-3 font-semibold text-gray-500 dark:text-gray-400"><CheckCircle2 className="text-green-500" size={20} /> 100 Trial SMS credits</li>
                <li className="flex items-center gap-3 font-semibold text-gray-500 dark:text-gray-400"><CheckCircle2 className="text-green-500" size={20} /> No credit card required</li>
              </ul>

              <a href="/api/auth/clover" className="block w-full py-5 rounded-2xl font-black text-xl border-2 border-gray-200 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all text-center">
                Start Free Trial
              </a>
            </div>
          </div>
      ...
      {/* FOOTER */}
      <footer className="py-20 bg-gray-900 dark:bg-black text-gray-400 dark:text-gray-500 px-6 text-center md:text-left">
        ...
        <div className="max-w-6xl mx-auto mt-20 pt-8 border-t border-gray-800 dark:border-gray-900 text-center text-sm font-medium">
