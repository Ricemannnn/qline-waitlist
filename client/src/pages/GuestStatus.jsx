...
import { 
  ...
  MapPin, RefreshCw, AlertCircle, Trash2, ExternalLink, Sun, Moon
} from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-[#FFFDF9] dark:bg-gray-950 flex flex-col items-center justify-center p-6 text-center transition-colors">
        <div className="max-w-md bg-white dark:bg-gray-900 p-10 rounded-[40px] shadow-xl border border-gray-100 dark:border-gray-800">
          ...
          <h1 className="text-2xl font-bold mb-4 dark:text-white">You're All Set!</h1>
    ...
    <div className="min-h-screen bg-[#FFFDF9] dark:bg-gray-950 flex flex-col items-center p-6 pt-12 md:pt-24 transition-colors duration-300">
      ...
      <div className="w-full max-w-lg">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-[40px] shadow-2xl shadow-gray-200/50 dark:shadow-black/20 border border-gray-100 dark:border-gray-800 overflow-hidden mb-8 transition-colors">
          ...
          <div className="p-8 md:p-12 text-center">
            {guest.status === 'notified' ? (
              <div className="mb-10">
                <div className="w-20 h-20 bg-green-100 dark:bg-green-900/20 text-green-600 dark:text-green-400 rounded-full flex items-center justify-center mx-auto mb-6 animate-bounce">
                  <CheckCircle2 size={40} />
                </div>
                <h3 className="text-3xl font-black text-gray-900 dark:text-white mb-2">Your table is ready!</h3>
                <p className="text-gray-500 dark:text-gray-400 font-medium">Please head to the host stand to be seated.</p>
              </div>
            ) : (
              <div className="mb-10">
                <div className="flex flex-col items-center mb-6">
                  <span className="text-gray-400 dark:text-gray-500 font-bold uppercase tracking-widest text-xs mb-2">Your Position</span>
                  <div className="text-7xl font-black text-[#F36D21] tracking-tighter">#{position}</div>
                </div>
                
                <div className="flex items-center justify-center gap-2 text-gray-500 dark:text-gray-400 mb-10">
                  <Users size={18} className="text-[#F36D21]" />
                  <p className="text-lg font-bold text-gray-900 dark:text-white">{ahead} Parties Ahead of You</p>
                </div>

                <div className="w-full bg-gray-100 dark:bg-gray-800 h-3 rounded-full mb-10 overflow-hidden">
                  <div 
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-orange-50/50 dark:bg-orange-950/20 p-6 rounded-3xl border border-orange-100 dark:border-orange-900/30">
                    <div className="flex justify-center mb-3">
                      <Clock className="text-[#F36D21]" size={24} />
                    </div>
                    <p className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-1">Est. Wait</p>
                  ...
                  <div className="bg-orange-50/50 dark:bg-orange-950/20 p-6 rounded-3xl border border-orange-100 dark:border-orange-900/30">
                    ...
                    <p className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-1">Party Size</p>
            ...
            <div className="space-y-4">
              {menu_url && (
                <a 
                  ...
                  className="flex items-center justify-center gap-2 w-full py-4 bg-gray-900 dark:bg-black text-white rounded-2xl font-bold hover:bg-black transition-all shadow-lg"
                >
              ...
              <button 
                ...
                className="flex items-center justify-center gap-2 w-full py-4 bg-white dark:bg-gray-800 border-2 border-red-50 dark:border-red-900/20 text-red-500 rounded-2xl font-bold hover:bg-red-50 dark:hover:bg-red-900/30 transition-all disabled:opacity-50"
              >
        ...
        <div className="text-center">
          <p className="text-gray-400 dark:text-gray-500 font-medium text-sm mb-6 flex items-center justify-center gap-2">
            <RefreshCw size={14} className={isRefreshing ? 'animate-spin' : ''} />
            Page auto-updates as your position changes
          </p>
          <div className="flex items-center justify-center gap-6">
            <div className="flex flex-col items-center text-gray-400 dark:text-gray-500">
               <div className="w-10 h-10 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 flex items-center justify-center mb-2">
